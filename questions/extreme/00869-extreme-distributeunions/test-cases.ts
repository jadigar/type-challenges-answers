...
type Cases = [
  ...
  { type: 'a', value: number } | { type: 'a', value: string } | { type: 'b', value: false } | { type: 'b', value: true }
  >
  >,
  Expect<
  Equal<
  ...
  | { type: 'b', msg: string }
  >,
  { type: 'a', option: { kind: 'none' } } | { type: 'a', option: { kind: 'some', value: 'x' } } | { type: 'a', option: { kind: 'some', value: 'y' } } | { type: 'b', msg: string }
  >
  >,
  // mixed structures:
  Expect<
  ...
  17 | [{ value: 'a' }, { x: { y: 2 } }] | [{ value: 'a' }, { x: { y: 3 } }] | [{ value: 'b' }, { x: { y: 2 } }] | [{ value: 'b' }, { x: { y: 3 } }] | [10, { x: { y: 2 } }] | [10, { x: { y: 3 } }]
  >
  >,
];
